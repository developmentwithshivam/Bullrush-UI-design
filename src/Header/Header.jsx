...
function Header() {
  return (
    <>
      <header className="bg-black  w-full h-20 flex justify-between">
        <div className="flex justify-startbg-blue-600">
          ...
          <div className="hidden text-white list-none lg:flex justify-between  lg:items-center lg:text-lg ">
            <NavLink
              ...
              className={({ isActive }) =>
                `${
                  isActive
                    ? "text-red-600 border-red-600 border-t-2 p-5"
                    : "text-white"
                } hover:text-red-600 cursor-pointer border-red-600 border-0 hover:border-t-2 p-5`
              }
            >
              Home
            </NavLink>
          ...
          <NavLink
            to="Signup"
            className="cursor-pointer bg-red-600 p-1 pl-7 pr-7 h-9 mt-6 ml-3 hover:text-black hover:bg-white rounded-md hidden lg:block"
          >
            Play Free
          </NavLink>
        </div>
